...
class Bhimashankar : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bhimashankar) // Sets the layout for the activity
        ...
        val bookNowButton: Button = findViewById(R.id.bhimashankarbooknow)
